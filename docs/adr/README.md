...
| 0010 | | reserved | [#11](https://github.com/Performant-Labs/holler/issues/11) |
| 0011 | | reserved | [#12](https://github.com/Performant-Labs/holler/issues/12) |
| 0012 | | reserved | [#13](https://github.com/Performant-Labs/holler/issues/13) |
| 0013 | | reserved | [#14](https://github.com/Performant-Labs/holler/issues/14) |
| 0014 | | reserved | [#15](https://github.com/Performant-Labs/holler/issues/15) |
| 0015 | | reserved | [#16](https://github.com/Performant-Labs/holler/issues/16) |
...
The ADRs that existed under `holler-server` and `holler-client` are retired by this scheme; their decisions are folded into the slots above as they are rewritten. The first of those is [ADR 0001](ADR-0001.md).
