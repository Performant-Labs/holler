...
Filing rules, Phase 1 (Pre-flight), Phase 2's plan/run mechanics, and Phase 3 (Findings report) are canonical in workflow repo — read and follow `$WORKFLOW_ROOT/workflow/review-battery-all.md` verbatim for those sections; do not hand-copy them here, they will drift. This file carries ONLY Holler's specific default-battery pass prompts below.
