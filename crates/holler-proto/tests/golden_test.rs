...
fn docs_instances() -> Vec<(&'static str, Value)> {
    vec![
        ...
        ("Hello.hub", serde_json::to_value(Hello {
            protocol: 2, protocol_min: 2, protocol_max: 2, role: "hub".into(), hostname: "hub-host".into(),
        ...
        ("Status.hub", serde_json::to_value(Status {
            role: "hub".into(), protocol: 2, protocol_min: 2, protocol_max: 2, hostname: "hub-host".into(),
