...
**Homebrew** (macOS/Apple Silicon, Linux/x86_64, or Linux/arm64 — via [Homebrew on Linux](https://docs.brew.sh/Homebrew-on-Linux)):
...
`~/.local/bin/holler`. Pin a specific version with `HOLLER_VERSION=v0.3.0`, or change the
